...
import { Animated, Dimensions, Image, FlatList, Modal, StyleSheet, ScrollView, Button, View, TouchableOpacity } from 'react-native';
...
class Welcome extends Component {
  ...
  render() {
    ...
    return (
      ...
      <View style={{ flex: 1 }}>
        <Image style={styles.bgImage} source={require('../assets/images/home.png')} />
        <View style={{ flex: 1 }}>

        </View>
        <View style={{ flex: 1, alignSelf: "center", justifyContent: "center" }}>
          <TouchableOpacity style={[styles.buttonContainer, styles.loginButton]} onPress={() => navigation.navigate('SignIn')}>
          ...
          {/* <TouchableOpacity style={styles.buttonContainer}  onPress={() => this.setState({ showTerms: true })}>
...
Welcome.defaultProps = {
  illustrations: [
    { id: 1, source: require('../assets/images/display1.png') },
    { id: 2, source: require('../assets/images/display2.png') },
    { id: 3, source: require('../assets/images/display1.png') },
  ],
};
